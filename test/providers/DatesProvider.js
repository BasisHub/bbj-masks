;(function(root, undefined) {
  var DatesProvider = [
    ...
    { date: '2018-02-15 14:01:06', mask: '%Hl', expected: '14' },
    {
      date: '2018-02-15 14:01:06',
      mask: '%Hp',
      expected: String.fromCharCode('14')
    },
    ...
    // Edge Cases
    {
      date: '2016-2-25 8:00:00',
      mask: '%Y-%Mz-%Dz %hz:%mz:%sz',
      expected: '2016-02-25 08:00:00'
    },
    {
      date: '2016-2-25 0:0:0',
      mask: '%Y-%Mz-%Dz %Hz:%mz:%sz',
      expected: '2016-02-25 00:00:00'
    }
  ]
